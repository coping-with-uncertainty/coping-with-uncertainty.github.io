...
latex_table <- texreg::texreg(list(ergm_model, indep_model), caption = "Results for the UK Faculty network of the ERGM modedl with and without dependence inducing terms,",caption.above = TRUE, stars = numeric(0),
