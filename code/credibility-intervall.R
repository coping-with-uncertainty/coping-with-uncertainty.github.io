...
if (generate_pdf) pdf("plots/credibility-1.pdf", height = 4, width = 6)
plot(xx, y, type = "l", lwd = 3, xlab = "y", ylab = "Density",
     main = "90% Credibility Interval", las = 1, bty = "l")
...
if (generate_pdf) pdf("plots/credibility-2.pdf", height = 4, width = 6)
plot(xx, y, type = "l", lwd = 3, xlab = "y", ylab = "Density",
     main = "Credibility Interval with y = 2", las = 1, bty = "l")
...
if (generate_pdf) pdf("plots/credibility-3.pdf", height = 4, width = 6)
plot(xx, y, type = "l", lwd = 3, xlab = "y", ylab = "Density",
     main = "Credibility Interval with y = 0.57", las = 1, bty = "l")
