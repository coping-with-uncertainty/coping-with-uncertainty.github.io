...
![](zero-inflation_files/figure-gfm/unnamed-chunk-1-1.png)<!-- -->
...
![](zero-inflation_files/figure-gfm/unnamed-chunk-1-2.png)<!-- -->
...
![](zero-inflation_files/figure-gfm/unnamed-chunk-1-3.png)<!-- -->
...
![](zero-inflation_files/figure-gfm/unnamed-chunk-1-4.png)<!-- -->
...
```
    ...
    ## 
    ## Call:
    ## zeroinfl(formula = Y ~ 1)
    ## 
    ## Pearson residuals:
    ##     Min      1Q  Median      3Q     Max 
    ## -1.1762 -1.1762  0.1766  0.8530  3.8969 
    ## 
    ## Count model coefficients (poisson with log link):
    ##             Estimate Std. Error z value Pr(>|z|)    
    ## (Intercept) 1.607751   0.005456   294.7   <2e-16 ***
    ## 
    ## Zero-inflation model coefficients (binomial with logit link):
    ##             Estimate Std. Error z value Pr(>|z|)    
    ## (Intercept) -0.83179    0.02201   -37.8   <2e-16 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 
    ## 
    ## Number of iterations in BFGS optimization: 10 
    ## Log-likelihood: -2.129e+04 on 2 Df
