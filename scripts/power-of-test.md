...
if (generate_pdf) pdf("power-11.pdf", width = 6, height = 4)
...
lines(mu, 1 - pnorm(1.64 - mu * sqrt(2 * n)), lty = 2, lwd = 3)
lines(mu, 1 - pnorm(1.64 - mu * sqrt(n)), lty = 1, lwd = 3)
abline(h = 0.05, lty = 3)
abline(v = 0, lty = 3)
text(0.15, 0.6, "n=60")
text(0.5, 0.6, "n=30")
...
![](power-of-test_files/figure-gfm/unnamed-chunk-1-1.png)<!-- -->
...
mu0 <- seq(0, 1, by = 0.01)
if (generate_pdf) pdf("power-21.pdf", width = 6, height = 4)
plot(mu0, 1 - pnorm(1.64 - mu0 * sqrt(n)), 
     type = "l", lwd = 3, 
     xlim = c(-1, 1), ylim = c(0, 1), 
     ylab = expression(P( ~ "''" ~ H[1] ~ "''" ~ "|" ~ mu )),
     xlab = expression(mu))
lines(mu0, 1 - pnorm(1.64 - mu0 * sqrt(2 * n)), lty = 2, lwd = 3)
polygon(c(-1, 0, 0, -1), c(0, 0, 0.05, 0.05), col = "lightblue")
abline(h = 0.05, lty = 3)
abline(v = 0, lwd = 2)
text(0.15, 0.6, "n=60")
...
![](power-of-test_files/figure-gfm/unnamed-chunk-1-2.png)<!-- -->
...
if (generate_pdf) pdf("power-31.pdf", width = 6, height = 4)
plot(mu0, 1 - pnorm(1.64 - mu0 * sqrt(n)), 
     type = "l", lwd = 3, 
     xlim = c(-1, 1), ylim = c(0, 1), 
     ylab = expression(P( ~ "''" ~ H[1] ~ "''" ~ "|" ~ mu )),
...
lines(mu0, 1 - pnorm(1.64 - mu0 * sqrt(2 * n)), lty = 2, lwd = 3)
lines(mu0, 1 - pnorm(1.64 - mu0 * sqrt(n)), lty = 1, lwd = 3)
abline(v = 0.25, lwd = 2)
polygon(c(-1, 0, 0, -1), c(0, 0, 0.05, 0.05), col = "lightblue")
abline(h = 0.05, lty = 3)
abline(v = 0, lwd = 2)
...
![](power-of-test_files/figure-gfm/unnamed-chunk-1-3.png)<!-- -->
...
mu0 <- seq(0.245, 1, by = 0.01)
if (generate_pdf) pdf("power-41.pdf", width = 6, height = 4)
plot(mu0, 1 - pnorm(1.64 - mu0 * sqrt(n)), 
     type = "n", lwd = 3, 
...
lines(mu0, 1 - pnorm(1.64 - mu0 * sqrt(2 * n)), lty = 1, lwd = 3)
lines(mu0, 1 - pnorm(1.64 - mu0 * sqrt(3 * n)), lty = 2, lwd = 3)
lines(mu0, 1 - pnorm(1.64 - mu0 * sqrt(4 * n)), lty = 3, lwd = 3)
abline(v = 0.25, lwd = 2)
polygon(c(-1, 0, 0, -1), c(0, 0, 0.05, 0.05), col = "lightblue")
abline(h = 0.05, lty = 3)
abline(v = 0, lwd = 2)
...
![](power-of-test_files/figure-gfm/unnamed-chunk-1-4.png)<!-- -->
