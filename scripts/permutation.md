...
![](permutation_files/figure-gfm/unnamed-chunk-1-1.png)<!-- -->
...
![](permutation_files/figure-gfm/unnamed-chunk-1-2.png)<!-- -->
...
```
    ...
    ## Warning in ks.test.default(y, z): p-value will be approximate in the presence
    ## of ties
...
```
    ...
    ## Warning in ks.test.default(xs[1:n], xs[(n + 1):(n + m)]): p-value will be
...
![](permutation_files/figure-gfm/unnamed-chunk-1-3.png)<!-- -->
